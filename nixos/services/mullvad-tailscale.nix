...
#
# This file defines a NixOS module.
# Place it in your NixOS configuration directory, for example, at /etc/nixos/modules/mullvad-tailscale.nix
# Then import it in your configuration.nix or flake.nix.
{
  config,
  lib,
  pkgs,
